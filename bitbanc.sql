	...
	CREATE TABLE senhas(
		...
		FOREIGN KEY(login) REFERENCES usuarios(id_usuario)
	);
	...
	INSERT INTO usuarios(nomeCompleto,email,CPF,dataNasc) VALUES("Teste","teste@gmail.com","000.000.000-00","2018-10-12");
